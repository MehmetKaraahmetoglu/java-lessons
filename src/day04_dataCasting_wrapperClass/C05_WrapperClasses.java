...
public class C05_WrapperClasses {
    public static void main(String[] args) {
        ...
        ANCAK
        primitive data turleri icinde hazir methodlar kullanabilecek Wrapper class'lar olusturmustur.
        ...
        Wrapper classlar primitive data turleri ile  hic problemsiz atama yapilabilir.
         */
        ...
        //Wrapper classelr arasinda casting olmaz.
