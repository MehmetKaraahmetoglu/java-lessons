...
public class C02_MultipleExceptions {
    ...
    /*
    Bir kodda birden fazla exception olasiligi olabilir.

    Ornegin bu soruda
    -ArrayIndexOutOfBoundsException(9 index)
    -StringIndexOutOfBoundsException(22 index)
    -InputMismatchException (int yerine baska bir karakter)
    olusma olasiligi var.

    Birden fazla exception olasiligi varsa
    asagidaki adimlarla ilerlemek gerekir.

    1- Olusmasi muhtemel exception'lar icin parent-child iliskisi varsa
        -her biri icin ayri try-catch(her hata)
        -bir try ve her bir exception icin ayri catch
        -bir try ve olasi tüm exceptionlari kapsayan genel bir catch.
    2- olusmasi muhtemel exceptionlar arasinda parent child iliskisi varsa
        -birden fazla catch cümlesi yazilacaksa, once child, sonra parent yazilabilir
